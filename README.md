...
**Aadi-Vault** is a high-security encryption utility designed to protect your files, images, and `.exe` files in a **100% offline** environment. The application runs on a **Localhost**, ensuring that your sensitive data never touches the internet or any external server.
...
3. **Password Sharing:** If you choose to share your password with others, you do so at your own risk. **Kyxgo technology** and its developer, **Aditya Rai**, are not liable for any data breach resulting from user negligence.
